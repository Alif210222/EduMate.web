...
//   }, [user]);
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const res = await axios.post("http://localhost:5000/costs", newCost);
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-6 mt-26 min-h-screen">
      {/* 🔹 Header */}
      <motion.h1
        initial={{ opacity: 0, y: -10 }}
        animate={{ opacity: 1, y: 0 }}
        className="text-2xl font-bold text-center text-blue-700 flex items-center justify-center gap-2"
      >
